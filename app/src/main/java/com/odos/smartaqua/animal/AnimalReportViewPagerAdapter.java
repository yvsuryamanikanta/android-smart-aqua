...
public class AnimalReportViewPagerAdapter extends FragmentStatePagerAdapter {

    private ArrayList<CultureModel> _cultureModelArrayList;
    private Context _context;

    public AnimalReportViewPagerAdapter(Context context, FragmentManager fm, int behavior, ArrayList<CultureModel> cultureModelArrayList) {
        super(fm, behavior);
    ...
    public Fragment getItem(int position) {
        ...
        return AnimalReportFragment.newInstance(cultureId,cultureAccess);
    }
