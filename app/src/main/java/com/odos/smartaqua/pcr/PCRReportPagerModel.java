...
public class PCRReportPagerModel extends BaseObservable implements ServiceAsyncResponse {
    private PCRReportViewPagerAdapter viewPagerAdapter;
    ...
    public PCRReportPagerModel(Context context, ActivityPcrReportViewpagerBinding binding, ActivityBaseBinding activityBaseBinding) {
                    ...
                    if (status.equalsIgnoreCase("Sucess")) {
                        if (!response.equalsIgnoreCase("null")) {
                            ...
                            if (jsonArray.length() != 0) {
                                ...
                                viewPagerAdapter = new PCRReportViewPagerAdapter(_context, ((AppCompatActivity) _context).getSupportFragmentManager(),
