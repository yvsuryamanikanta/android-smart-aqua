...
public class TreatmentObservationViewModel extends ViewModel implements ServiceAsyncResponse {
    private Context _context;
    private ActivityObservationTreatmentBinding _binding;
    private ServiceAsyncResponse serviceAsyncResponse;
    private ArrayList<UserRoles> userRolesArrayList;
    private int tankId;

    public TreatmentObservationViewModel(Context context, ActivityObservationTreatmentBinding binding) {
