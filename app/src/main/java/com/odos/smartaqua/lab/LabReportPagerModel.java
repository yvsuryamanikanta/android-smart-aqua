...
public class LabReportPagerModel extends BaseObservable implements ServiceAsyncResponse {
    private LabReportViewPagerAdapter labReportViewPagerAdapter;
    ...
    public LabReportPagerModel(Context context, ActivityLabReportViewpagerBinding activityLabReportViewpagerBinding, ActivityBaseBinding activityBaseBinding) {
        this._context = context;
        this._binding = activityLabReportViewpagerBinding;
                    ...
                    if (status.equalsIgnoreCase("Sucess")) {
                        if (!response.equalsIgnoreCase("null")) {
                            ...
                            if (jsonArray.length() != 0) {
                                ...
                                labReportViewPagerAdapter = new LabReportViewPagerAdapter(_context, ((AppCompatActivity) _context).getSupportFragmentManager(),
                                        FragmentStatePagerAdapter.BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT, cultureModelArrayList);
                                _binding.pager.setAdapter(labReportViewPagerAdapter);
