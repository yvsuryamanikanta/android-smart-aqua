...
public class AddProductActivity extends BaseActivity implements UploadBottomSheetFragment.ItemClickListener {
    private ActivityAddproductBinding _binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LayoutInflater mInflater = LayoutInflater.from(AddProductActivity.this);
        _binding = DataBindingUtil.inflate(mInflater, R.layout.activity_addproduct, activityBaseBinding.baseFragment, true);
        viewModel = new AddProductViewModel(AddProductActivity.this, _binding);
