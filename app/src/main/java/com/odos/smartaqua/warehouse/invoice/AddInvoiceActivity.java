...
public class AddInvoiceActivity extends BaseActivity implements UploadBottomSheetFragment.ItemClickListener {
    private ActivityAddinvoiceBinding _binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LayoutInflater mInflater = LayoutInflater.from(AddInvoiceActivity.this);
        _binding = DataBindingUtil.inflate(mInflater, R.layout.activity_addinvoice, activityBaseBinding.baseFragment, true);
        viewModel = new AddInvoiceViewModel(AddInvoiceActivity.this, _binding);
