...
public class StockingListViewPagerAdapter extends FragmentStatePagerAdapter {

    private JSONArray jsonArray;
    private Context _context;

    public StockingListViewPagerAdapter(Context context, FragmentManager fm, int behavior, JSONArray response) {
        super(fm, behavior);
    ...
    public Fragment getItem(int position) {
        try {
            ...
            return StockingListFragment.newInstance(position, tankId, cultureId, tankName,""+jsonArray);
        } catch (Exception e) {
            return null;
        }
    }
