...
public class PreparationListFragmentViewModel extends BaseObservable implements ServiceAsyncResponse {

    private Context _context;
    private FragmentPreparationlistBinding _fragmentBinding;
    ...
    public PreparationListFragmentViewModel(int position, Context context, FragmentPreparationlistBinding listBinding, String tId, String cId, String tName, String response) {
        ...
        this._fragmentBinding = listBinding;
