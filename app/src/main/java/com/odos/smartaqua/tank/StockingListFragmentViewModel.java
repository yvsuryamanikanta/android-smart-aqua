...
public class StockingListFragmentViewModel extends BaseObservable implements ServiceAsyncResponse {

    private Context _context;
    private FragmentStockinglistBinding _fragmentBinding;
    ...
    public StockingListFragmentViewModel(int position, Context context, FragmentStockinglistBinding listBinding, String tId, String cId, String tName, String response) {
