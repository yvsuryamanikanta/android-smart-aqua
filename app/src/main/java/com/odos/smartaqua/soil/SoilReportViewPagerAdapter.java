...
public class SoilReportViewPagerAdapter extends FragmentStatePagerAdapter {

    private ArrayList<CultureModel> _cultureModelArrayList;
    private Context _context;

    public SoilReportViewPagerAdapter(Context context, FragmentManager fm, int behavior, ArrayList<CultureModel> cultureModelArrayList) {
        super(fm, behavior);
    ...
    public Fragment getItem(int position) {
        ...
        return SoilReportFragment.newInstance(cultureId,cultureAccess);
    }
