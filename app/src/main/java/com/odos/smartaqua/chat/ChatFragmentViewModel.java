...
public class ChatFragmentViewModel extends ViewModel implements ServiceAsyncResponse {
    ...
    public ChatFragmentViewModel(Context context, FragmentChatBinding activityAddFeedBinding) {
